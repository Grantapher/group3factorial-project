...
/**
 * Thrown when the total number of jobs exceeds the maximum number of
 * total jobs allowed.
 *
 * @version May 28, 2015
...
public class MaxJobsExceededException extends BRException {
    ...
    /**
     *  Constructs a MaxJobsExceededException with null as its error detail message.
     */
	...
	/**
	 * Constructs an MaxJobsExceededException with the specified detail message.
