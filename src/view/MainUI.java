    ...
    private static void login() {
        ...
        private static AbstractUser createUser(final String email) {
            ...
            if (userType == FileIO.PARK_MANAGER_CHAR) {
                ParkManager newManager = new ParkManager(last, first, email);
                String park;
                do {
                ...
                Volunteer newVolunteer = new Volunteer(last, first, email);
                try {
                ...
                Administrator newAdmin = new Administrator(last, first, email);
                try {
